...
<div class="row align-items-center">
    ...
    <div class="col-lg-6 mb-4">
		...
		<p data-aos="fade-up" data-aos-delay="300"><a href="#" class="btn btn-primary py-3 px-5 btn-pill" data-toggle="modal" data-target="#signin">Ingresar</a></p>
        <?php } ?>
    </div>
    ...
    <div class="modal fade" id="signin" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="form">
			<div class="modal-content">
				...
				<div class="modal-header">
        			<h3 class="modal-title h4 text-black mb-4">Ingreso sesión</h3>
        ...
        <div class="form-box">
            <h3 class="h4 text-black mb-4">Se Parte!</h3>
            <?php echo validation_errors(); ?>
