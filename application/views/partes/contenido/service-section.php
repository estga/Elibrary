    ...
    <div class="owl-carousel col-12 nonloop-block-14">
        ...
        <div class="course bg-white h-100 align-self-stretch">
            ...
            <div class="course-inner-text py-4 px-4">
                ...
                <p>Podrás utilizar el material bibliográfico y especial en nuestra sala de lectura o solicitarlo a domicilio.</p>
            </div>
            <div class="d-flex border-top stats">
                <div class="py-3 px-4"><span class="icon-book"></span> 72.193 libros</div>
            </div>
        </div>
        ...
        <div class="course bg-white h-100 align-self-stretch">
            ...
            <div class="course-inner-text py-4 px-4">
                ...
                <p>Un equipo especializado te brindara consejos y herramientas para aumentar tu productividad.</p>
            </div>
            <div class="d-flex border-top stats">
                <div class="py-3 px-4"><span class="icon-users"></span> 2,193 estudiantes</div>
            </div>
        </div>
        ...
        <div class="course bg-white h-100 align-self-stretch">
            ...
            <div class="course-inner-text py-4 px-4">
                ...
                <p>Nos esforzamos para que nuestro servicio cubra rápidamente tus expectativas.</p>
            </div>
            <div class="d-flex border-top stats">
                <div class="py-3 px-4"><span class="icon-note"></span> 1,193 trabajos</div>
            </div>
        </div>
        ...
        <div class="course bg-white h-100 align-self-stretch">
            ...
            <div class="d-flex border-top stats">
                <div class="py-3 px-4"><span class="icon-cube"></span> 2,193 deliveries</div>
            </div>
        </div>
        ...
        <div class="course bg-white h-100 align-self-stretch">
            ...
            <div class="course-inner-text py-4 px-4">
                ...
                <p>Un servicio de información profesional basado en prácticas y normas bibliotecológicas.</p>
            </div>
            <div class="d-flex border-top stats">
                <div class="py-3 px-4"><span class="icon-book"></span> 193 donaciones</div>
            </div>
        </div>
